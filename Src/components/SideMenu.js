                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.headerBackgrounContainer}>
                        ...
                        <View style={styles.headerContainer}>
                         ...
                         <Image style={styles.headerImgStyle1}
                    ...
                    <View style={{ width:hp('35'), borderWidth:hp('0.09'),borderColor:'#E6DFDF' ,marginLeft:hp('3')}}></View>
                    {/* List */}
                 ...
                 flexDirection: 'column',}}>
                         ...
                         <View style={{
                            ...
                            alignItems: 'flex-start',                         
                             marginLeft: hp('4'),   marginTop: hp('2'),
                        }}>
                            <Image style={{                            
                                width: hp('6'),
                                height: hp('7'),                     
                            ...
                            <Text style={styles.zylememiniTextStyle}>
                                ZYLEMINI+
                                </Text>
                        </View>
                       
                        <View style={{ flex: 0.2, flexDirection: 'row',  marginLeft: wp('7'), marginTop:hp('2'),alignContent:'center' }}>
                       
                        <TouchableOpacity  style={{ flex: 2.5, alignContent:'flex-start',justifyContent:'flex-start'}} onPress={() => Actions.PrivacyPolicy()}>
                                    <Text style={styles.PPTextStyle}>
                                        Privacy Policy
                                </Text>
                                </TouchableOpacity>
                                <View style={{   width:hp('1'),height:hp('2'), borderLeftWidth:hp('0.2'),borderColor:'#DFE9E0' }}></View>
                               
                                <TouchableOpacity style={{ flex: 2.7, alignItems:'flex-start',justifyContent:'flex-start',marginHorizontal:hp('1')}}>
                                ...
                                <TouchableOpacity style={{ flex: 1.5, alignItems:'flex-start',justifyContent:'flex-start',marginHorizontal:hp('1')}}  onPress={() => Actions.AboutUs()}>
...
const styles = StyleSheet.create({
    ...
    headerTextContainer: {
        flex: 1.5,
        flexDirection: 'column',
        justifyContent: 'center', marginLeft: wp('-6'),
    ...
    SNTextStyle: {
        color: '#362828',
        fontSize: wp('2.8'),
        fontFamily: 'Montserrat',marginLeft:hp('1')
