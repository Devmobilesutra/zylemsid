...
export class SalesReport extends Component {
    ...
    returnText1(brandId) {
        ...
        // db.getDataforcurrMonth(brandId, month, ConversionFormula2).then((data) => {
        //     if (data[0].qty == 'null') {   qty1 = 0.00

        //     } else {
        //         qty1 =JSON.parse(datas[0].qty)
        //     }
        //     return (
        //         <View>
        //             <Text style={{ color: '#362828', fontSize: 12, fontFamily: 'Proxima Nova' }}>{qty1}</Text>
        //         </View>    
        //     )
    ...
    _returnText4(brandId) {
        ...
        //     return (
        //         <View>
        //             <Text style={{ color: 'red', fontSize: 15, fontFamily: 'Proxima Nova' }}>{//console.log("khvjvh................", ytds)}5555</Text>
        //         </View>
        //     )
                                    ...
                                    <View style={styles.collapseHeaderStyle}>
                                        ...
                                        <View style={{ flex: 2, marginLeft: wp('4'), marginTop: wp('3'), flexDirection: 'row', }}>
                                            <View style={{ flex: 2, flexDirection: 'column', justifyContent: "flex-start" }}>
                                                <Text style={{ color: '#221818', fontSize: 10, fontFamily: 'Proxima Nova', fontWeight: 'bold' }}>{this.state.currentMonth}</Text>
                                                {this.returnText1(item.BRANDID)}

                                            </View>
                                            <View style={{ flex: 2, flexDirection: 'column' }}>
                                                <Text style={{ color: '#221818', fontSize: 10, fontFamily: 'Proxima Nova', fontWeight: 'bold' }}>{this.state.prev1Month}</Text>
                                                {this.returnText2(item.BRANDID)}

                                            </View>
                                            <View style={{ flex: 2, flexDirection: 'column' }}>
                                                <Text style={{ color: '#221818', fontSize: 10, fontFamily: 'Proxima Nova', fontWeight: 'bold' }}>{this.state.prev2Month}</Text>
                                                {this.returnText3(item.BRANDID)}
