...
import { StyleSheet, View, Text, TouchableOpacity, ScrollView,StatusBar ,Image, ImageBackground, AsyncStorage, Dimensions ,SafeAreaView} from 'react-native';
      ...
      <SafeAreaView style={styles.splashContainer}>
        ...
        <View style={styles.logoView}>
          <ImageBackground
            ...
            style={{ flex: 1, height: hp('100'), width: wp('100'), resizeMode: 'cover', justifyContent: 'center', }}>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start', marginTop: hp('20') }}>
