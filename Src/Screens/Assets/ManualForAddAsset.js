...
export  class ManualForAddAsset extends Component {
constructor(props) {
    super(props);
    this.state = { 
          value: '',
    ...
    return (
      ...
      <View style={styles.nameMainContainer}>
                ...
                <View>
                    ...
                    {/* //     <TouchableOpacity  onPress={() => Actions.DiscardAssetStep2()} ></TouchableOpacity> */}
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(ManualForAddAsset)
