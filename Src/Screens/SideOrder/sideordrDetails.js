...
var totalAmounts
export class sideordrDetails extends Component {
    constructor(props) {
        super(props);
        this.state = {
            a: '',
    ...
    _componentFocused = () => {
      ...
      // console.log("amount details on sideorderdetails",this.props.Shop_det.total_amount);
                    ...
                    >
                        ...
                        <View style={styles.container}>
                            <View style={styles.totalOrderContainer}>
                                ...
                                <Text style={styles.totalOrderValuesValueText1} >
                                {this.state.Shop_det[0].total_amount}
                                    {/* {this.state.total} */}
                        ...
                        {moment(this.state.Shop_det[0].Current_date_time).format('DD-MMM-YYYY')}
                        
                        </Text>
                        <Text style={styles.orderDateText1}>
                                   EXPECTED DELIVERY
                        </Text>
                        <Text style={styles.orderDatesDate}>
                        {moment(this.state.Shop_det[0].ExpectedDeliveryDate).format('DD-MMM-YYYY')}
...
export default connect(mapStateToProps, mapDispatchToProps)(sideordrDetails)
