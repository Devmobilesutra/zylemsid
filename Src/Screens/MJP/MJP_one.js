...
NextDate()
{
   ...
   this.setState({currentDate:moment().add(1, 'day').format('DD MMM')})
}

PrevDate()
{
   // alert(moment().subtract(1, 'day').format('MMM DD')) 
    this.setState({currentDate:moment().subtract(1, 'day').format('DD MMM')})
}
...
<View>
  ...
  <TouchableOpacity style={{ marginTop:hp('4%'),marginLeft:wp('2%')}}>
 ...
 source={require('../../assets/Icons/Search.png')}
  ...
  <TouchableOpacity onPress={() => this.PrevDate()} style={{marginLeft:('5%'), marginTop:hp('2.5%')}}>
<Image
...
<TouchableOpacity  onPress={() => this.NextDate()} style={{marginLeft:('7%'), marginTop:hp('2.5%')}}>
<Image
