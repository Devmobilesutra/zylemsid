...
import { StyleSheet, View, Text, ImageBackground, TouchableOpacity, ScrollView, FlatList, Image, AsyncStorage, BackHandler } from 'react-native';
...
export class Assets extends Component {
            ...
            for (var i = 0; i < data.length; i++) {
                db.getAseetListInfo(data[i].id).then((data1) => {
                  ...
                  //  this.state.TotalAssset.push(data1);
                    ...
                    //     }
                  //  });
                    console.log("for loop array====", JSON.stringify(this.state.TotalAssset))
                    this.setState({ aa: arr })
                })
                // for (let j = 0; j < data1.length; j++) {                        
                //     arr.push(data1[j]);
    ...
    render() {
        console.log("Rajanifinallllllllllllllllllllllllll", this.state.TotalAssset[0])
        return (
            <View style={{ flex: 1 }}>
                <ImageBackground
                                ...
                                <TouchableOpacity onPress={this.filterPopUp.bind(this)}>
                                    <View style={{ flex: 1 }}>
                                        <Dialog
                                            ...
                                            height={hp('45')}
                                            dialogStyle={{
                                                marginTop: hp('55'), borderTopRightRadius: wp('0'),
                                            ...
                                            <DialogContent>
                                                ...
                                                <View style={{
                                                    ...
                                                    <View style={{ flexDirection: 'row', }}>
                                                        <View style={{
                                                            backgroundColor: '#796A6A', borderColor: '#796A6A',
                                                            borderWidth: wp('0.3'),
...
const styles = StyleSheet.create({
    ...
    brandsTypeTextStyle: {
        ...
        fontFamily: 'Proxima Nova',
        fontSize: 12,
        marginTop: hp('1.5'), marginLeft: hp('-0.4')
