...
export class Shops extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            cardView: false,
            getRouteId: '',
            routeData: [], selectedRouteId: '', selectedRouteName: '',
            ShopsArray: [], totalshoplen: 0, totalVisited: 0, totalvisitedlen: 0,
            entity_idArr: [],
            totalVisitedArray: [],
            active: false
            // cardView: false ,
    ...
    static navigationOptions = ({ navigation }) => {
        ...
        if (params.cardView == true) {
                ...
                headerRight: (
                    <View style={{ flexDirection: "row", alignItems: 'center', justifyContent: 'center', alignSelf: 'center', }}>
                        ...
                        >
                            <View>
                                <Image style={{
                                    marginRight: hp('4'), height: hp('3'), width: wp('4'), color: '#8C7878',
                                    tintColor: '#8C7878'
                                }}
            ...
            return {
                ...
                headerTintColor: '#fff',
                headerTitleStyle: {
                    color: '#fff', marginLeft: wp('-2'),fontSize:24,fontWeight:'bold'
                },
                headerRight: (
                    <View style={{ flexDirection: "row", alignItems: 'center', justifyContent: 'center', alignSelf: 'center', }}>
                        <TouchableOpacity
        ...
        AsyncStorage.getItem('routeId').then((keyValue) => {
            ...
            db.getCustomerId(JSON.parse(keyValue)).then((data) => {
                ...
                for (var i = 0; i < this.state.entity_idArr.length; i++) {
                    db.getTotalVisitedCount(datess, this.state.entity_idArr[i].CustomerId).then((data) => {
                        if (data.length > 0) {
                                ...
                                <View style={styles.shopListBackContainerCard}>
                                    ...
                                    <View style={styles.NCMContainerCard}>
                                        ...
                                        <View style={styles.msgContainerCard}>
                                            <TouchableOpacity onPress={() => Communications.text('0123456789', 'Test Text Here')}>
...
const styles = StyleSheet.create({
    ...
    dropDownContainer: {
        ...
        paddingHorizontal: hp('2'), justifyContent:'center',alignContent:'center',alignSelf:'center',
        textAlign:'center',
        padding: 15,fontSize:11
    },
